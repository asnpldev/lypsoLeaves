    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action=".?route=authenticate&action=login" method="post">
          ...
          <span class="absolute left-0 inset-y-0 flex items-center pl-3">
            ...
            <svg class="h-5 w-5 text-blue-500 transition duration-200 ease-in-out group-hover:text-blue-400 transform hover:translate-x-1" xmlns="http://www.w3.org/2000/svg"
